...
sed -i "s/upload_max_filesize = .*/upload_max_filesize = 300M/" /etc/php/7.3/apache2/php.ini
sed -i "s/post_max_size = .*/post_max_size = 300M/" /etc/php/7.3/apache2/php.ini
# Change max upload size for CLI requests
sed -i "s/upload_max_filesize = .*/upload_max_filesize = 300M/" /etc/php/7.3/cli/php.ini
 sed -i "s/post_max_size = .*/post_max_size = 300M/" /etc/php/7.3/cli/php.ini
